...
// Content Icons
export function ProfileIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
...
export function MailIconSolid(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
