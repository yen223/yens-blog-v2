...
export async function loader({ params }: LoaderFunctionArgs) {
  const redirects = {
    ...
    "a-gentle-introduction-to-functors":
      "/articles/a-gentle-introduction-to-functors",
    "set-up-ubuntu-server": "/articles/set-up-ubuntu-server",
    "on-professional-communications":
      "/articles/on-professional-communications",
    "a-reflection-on-my-masters-course":
      "/articles/a-reflection-on-my-masters-course",
  };
  ...
  if (redirectUrl) {
    ...
    throw new Response(
      "The link you followed is either outdated or incorrect.",
      { status: 404 }
    );
  }
}
