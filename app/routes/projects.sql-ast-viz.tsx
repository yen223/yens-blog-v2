...
export async function action({ request }: ActionFunctionArgs) {
    ...
    if (typeof sql !== "string") {
        return data({ sql: "", ast: null, error: "SQL query is required" }, { status: 400 });
    }
...
export default function SQLASTViz() {
    const { sql = "", ast, error: actionError } = useActionData<typeof action>() ?? {};

    return (
        <div className="max-w-4xl mx-auto p-6">
            <h1 className="text-3xl font-bold mb-6 text-zinc-800 dark:text-zinc-100">SQL AST Visualizer</h1>
            ...
            {actionError && (
                <div className="mt-4 p-4 bg-red-100/10 border border-red-400/20 
            ...
            {ast && (
                <div className="mt-4">
                    ...
                    <pre className="bg-zinc-50 dark:bg-zinc-800/90 p-4 rounded overflow-auto
